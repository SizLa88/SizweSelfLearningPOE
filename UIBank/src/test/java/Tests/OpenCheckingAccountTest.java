...
public class OpenCheckingAccountTest {
    ...
    public void testOpenCheckingAccount() throws InterruptedException
    {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='accountNickname']"))).sendKeys("SizCheckAcc");

        Thread.sleep(2000);

        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='typeOfAccount']/option[1]"))).click();
        ...
        System.out.println("Open Checking Account Successful");
